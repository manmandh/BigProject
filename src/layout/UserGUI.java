...
public class UserGUI extends javax.swing.JFrame {
    ...
    boolean check = true;
    public UserGUI(ResultSet resultSet) throws FileNotFoundException, IOException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        button_Doi_Mk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/pas32.png"))); // NOI18N
        ...
        button_DangXuat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/out.png"))); // NOI18N
    ...
    private void button_DangXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_DangXuatActionPerformed
        ...
        if (evt.getSource() == button_DangXuat) {
            ...
            if (a == 0) {
                SignInPlayer N = new SignInPlayer();
                N.setVisible(true);
                dispose();
            }
        }
