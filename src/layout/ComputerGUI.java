...
public class ComputerGUI extends javax.swing.JFrame {
    private ListComputer dsmaytinh;
    ...
    Computer n1 = new Computer();
    Computer n2 = new Computer();
    Computer n3 = new Computer();
    Computer n4 = new Computer();
    Computer n5 = new Computer();
    Computer n6 = new Computer();
    boolean m1 = false, m2 = false, m3 = false, m4 = false, m5 = false, m6 = false;
    int count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0, count6 = 0;
    
    public ComputerGUI() {
        initComponents();
        dsmaytinh=new ListComputer();
        myInit();
    ...
    private void initComponents() {
        ...
        butt_may5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        butt_may2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        butt_may3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        butt_tinhtien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/money2.png"))); // NOI18N
        ...
        butt_may1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        butt_may6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        butt_may4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/comp.png"))); // NOI18N
        ...
        buttLSMM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/lsmomay.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/dánhachhoivien.png"))); // NOI18N
        ...
        MENU_LichSuMoMay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/lsmomay.png"))); // NOI18N
        ...
        MENU_DoiMatKhau.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/pas12.png"))); // NOI18N
        ...
        MENU_DangXuat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/out.png"))); // NOI18N
    ...
    private void tb_momayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_momayMouseClicked
        ...
        Computer nv = dsmaytinh.Tim(String.valueOf(tb_momay.getValueAt(row, 0)).trim());
    ...
    private void buttLSMMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttLSMMActionPerformed
        // TODO add your handling code here:
        try {
            HistoryTurnOn G = new HistoryTurnOn();
            G.setVisible(true);
        } catch (IOException ex) {
            Logger.getLogger(ComputerGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void ThemMotDong(Computer nv){
    ...
    private void NapDuLieu(){
        XoaDuLieu();
        for(Computer nv : dsmaytinh.getDS()){
            ThemMotDong(nv);
        }
    }
