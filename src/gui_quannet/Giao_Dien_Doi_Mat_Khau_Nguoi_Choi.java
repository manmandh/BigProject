...
public class Giao_Dien_Doi_Mat_Khau_Nguoi_Choi extends javax.swing.JFrame {
    public Giao_Dien_Doi_Mat_Khau_Nguoi_Choi() {
        initComponents();
    }
    ...
    private void btDMKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDMKActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Giao_Dien_Doi_Mat_Khau_Nguoi_Choi.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Giao_Dien_Doi_Mat_Khau_Nguoi_Choi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
